...
public class BigDec {
	...
	public static BigDecimal valueOf(double value, int scale) { return new BigDecimal(value).setScale(scale, RoundingMode.HALF_UP); }
	
	public static BigDecimal valueOf(double value) { return new BigDecimal(value).setScale(0, RoundingMode.HALF_UP); }
